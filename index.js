...
kayla.sendNode({
  tag: 'call',
    attrs: {
      from: '62895401318753@s.whatsapp.net',
      id: Id,
      t: T
    },
    content: [
...
"optionName": "KATANYA KEBAL"
	...
	{
"optionName": "GILANG BOT"
	}
],
"selectableOptionsCount": 5
}}}})
} else if (anu.action == 'remove') {
kayla.sendMessage(anu.id, { text : `Goodbye @${num.split("@")[0]}, Selamat Tinggal Semoga Kau Bisa Tenang`, mentions : [num]},{ quoted : {
key: {
fromMe: false, 
participant: `0@s.whatsapp.net`, 
...({ remoteJid: "status@broadcast" }) 
...
"businessOwnerJid": `62895401318753@s.whatsapp.net`
}
}, options)
